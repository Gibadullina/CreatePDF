...
private void addRows(PdfPTable table, BaseFont font) {
		...
		Phrase cell1 = new Phrase(Calc.NumberGet, new Font(font,13));
		Phrase cell2 = new Phrase(Calc.GroupGet, new Font(font,13));
		Phrase cell3 = new Phrase(Calc.FIOGet, new Font(font,13));
		Phrase cell4 = new Phrase(Calc.PointsGet, new Font(font,13));
